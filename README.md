...
- 🔍 Search for capsule medicines  
- 🔄 Find substitute medicines instantly  
...
```bash
git clone https://github.com/your-username/Capsule-Medicine-Substitute-Finder.git
cd Capsule-Medicine-Substitute-Finder
